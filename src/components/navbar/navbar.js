...
//    toggleIcons(); // add this back when using "x" for mobile resize
  ...
  setTagVisibility(isLanding){
    ...
    // if (hasTight && w <= 1115) {
    //   console.log('tight navbar remove');
  ...
  setInitialLogoPosition() {
    ...
    this.headerContainers.headerLogo.removeClass('navbar-logo--init');
  }
