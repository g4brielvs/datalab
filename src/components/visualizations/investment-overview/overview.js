    ...
    return (
      <div id="investment-overview__viz">
        ...
        <div id="investment-subtext">
		  ...
		  Although student aid includes the $11.6 billion investment made through the <a className="cu-link" href="https://www.va.gov/education/about-gi-bill-benefits/" target="_blank">G.I. Bill of Rights</a>, it is not included in this analysis because we were not able to make a direct connection between that investment and the benefits given to an institution.
	          </p>
          </div>
          <div className="aid-subsection">
