...
export default class SankeyPopup extends React.Component {
  ...
  */
  ...
  findLinks = (agency) => {
    let subagencies = this.findSubagencies(agency);
    ...
    //    console.log(this.getUnique(societiesToAgency));
    // console.log(this.getUnique(societiesToAgency,'linkedSociety'));
    // console.log((new Set(societiesToAgency)));
    // console.log(societiesToAgency);
    
    return this.getUnique(societiesToAgency, 'linkedSociety');
//    return (societiesToAgency);
  };
