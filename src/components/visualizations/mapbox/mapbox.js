...
class Mapbox extends React.Component {
  ...
  render() {
    ...
    // we're going to pass in these as props. For CG 
    // they are going to have to pass in a Tumblr property (i believe?) Same rules apply.
    return (
	<div>
	...
	<div id="collegesMap" style={mapStyle}></div>
	</div>
    );
  };
};
