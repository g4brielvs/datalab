    ...
    return (
      <div>
        <ul className={`mobileDropdown ${show ? `` : `hidden`}`}>
          <li className='navListItemMobile' data-id='0' onClick={this.handleClick}><a href='#'>Analyses</a><span className='navListArrow'> <Arrow/></span></li>
          <ul className={`toggleList ${this.state.clickedItem == 'Analyses' ? `` : `hidden`}`}>{this.returnActiveList(this.state.data[0].analyses)}</ul>
          <li className='navListItemMobile' data-id='1' onClick={this.handleClick}><a href='#'>DataLab Express</a><span className='navListArrow'> <Arrow/></span></li>
          <ul className={`toggleList ${this.state.clickedItem == 'DataLab Express' ? `` : `hidden`}`}>{this.returnActiveList(this.state.data[1].express)}</ul>
          <li className='navListItemMobile' data-id='2' onClick={this.handleClick}><a href='#'>America's Finance Guide</a><span className='navListArrow'> <Arrow/></span></li>
          ...
          <li className='navListItemMobile' data-id='3' onClick={this.handleClick}><a href='#'>Resources</a><span className='navListArrow'> <Arrow/></span></li>
          <ul className={`toggleList ${this.state.clickedItem == 'Resources' ? `` : `hidden`}`}>{this.returnActiveList(this.state.data[3].resources)}</ul>
          <li className='navListItemMobile' data-id='4'onClick={this.handleClick}><a href='#'>Glossary</a><span className='navListArrow'> <Arrow/></span></li>
