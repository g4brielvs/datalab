    ...
    return (
        <>
            ...
            <SEO
                ...
                socialMediaText='How much is the federal deficit? Check out #YourGuide for visualizations and .CSV data to do your own analysis. #DataLab #OpenGov'
            />
            ...
            <Default>
                ...
                <section className="hwcta">
                    ...
                    <div className="afg__download--div">
                        ...
                        <ul>
                            <li><a href="../../libs/assets/ffg/data/explore_federal_deficit.csv" download>explore_federal_deficit.csv</a></li>
                        </ul>
                    </div>
                    </Accordion>
                </section>
