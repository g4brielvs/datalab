    ...
    },
    {
      ...
      sources:
        <>
          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                ...
                <li className={styles.discList}>If the entity website listed the entity as being affiliated with a specific college or university
                  the name was normalized to the appropriate institution and the DUNS number was collected.
                </li>
              </ul>
            </li>
          </ol>
          ...
          <ul>
            <li>If the record consisted of unusual entities, we did a reverse look up on the DUNS number and researched
              the associated address to determine if the entity is connected with a qualifying institution.</li>
          </ul>
          <p>
